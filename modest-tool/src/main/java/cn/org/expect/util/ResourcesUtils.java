...
public class ResourcesUtils {
    ...
    public static String getMessage(String key, Object... args) {
        ...
        return message == null ? StringUtils.replacePlaceHolder(key, args) : StringUtils.replaceIndexHolder(message, args);
    }
    ...
    public static String[] getMessageArray(String key) {
        String str = ResourcesUtils.getMessage(key);
        return StringUtils.trimBlank(StringUtils.split(str, ';'));
    }
}
