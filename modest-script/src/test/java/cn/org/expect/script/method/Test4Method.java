...
@EasyVariableMethod(name = "test", variable = CharSequence.class, parameters = {int.class, Object[].class}, varargs = true)
public class Test4Method implements UniversalScriptVariableMethod {
