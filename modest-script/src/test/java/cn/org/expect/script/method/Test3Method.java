...
@EasyVariableMethod(name = "test", variable = CharSequence.class, parameters = {int.class, String.class, int[].class}, varargs = true)
public class Test3Method implements UniversalScriptVariableMethod {
