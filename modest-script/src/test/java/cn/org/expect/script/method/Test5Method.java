...
@EasyVariableMethod(name = "test", variable = CharSequence.class, parameters = {Object[].class}, varargs = true)
public class Test5Method implements UniversalScriptVariableMethod {
