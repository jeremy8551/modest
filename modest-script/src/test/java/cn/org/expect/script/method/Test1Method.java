...
@EasyVariableMethod(name = "test", variable = CharSequence.class, parameters = {int.class, int.class, String[].class}, varargs = true)
public class Test1Method implements UniversalScriptVariableMethod {
