...
public class XMLUtils {
     ...
     */
    public static String getEncoding(File xml) {
        try {
            return getEncoding(IO.read(new FileInputStream(xml)));
        } catch (IOException e) {
            throw new ModestRuntimeException(StringUtils.toString(xml), e);
        }
    }
