...
@EasyRunIf(values = {"forward.host", "forward.port", "forward.username", "forward.password", "forward.remote.host", "forward.remote.port", "forward.remote.username", "forward.remote.password"})
public class SSHPortForwardTest {
    private final static Log log = LogFactory.getLog(SSHPortForwardTest.class);
