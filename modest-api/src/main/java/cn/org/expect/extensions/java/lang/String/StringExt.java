...
public final class StringExt {
    ...
    public static List<CharSequence> splitLines(@This String str, List<CharSequence> list) {
    ...
    public static void testEncoding(@This String str) {
        StringUtils.testEncoding(str);
    }
