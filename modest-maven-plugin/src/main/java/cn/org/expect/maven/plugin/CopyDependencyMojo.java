...
public class CopyDependencyMojo extends AbstractMojo {
    ...
    public List<Dependency> merge(List<String> modules) throws Exception {
        ...
        List<MavenProject> projects = MavenUtils.find(allProjects, copySource);
        List<Dependency> dependencies = MavenUtils.deepReplace(list, projects);
        MavenUtils.dealScope(dependencies);
        return dependencies;
    }
    ...
    private void paste(List<Dependency> dependencies, String pasteModule) throws IOException, MojoExecutionException {
        ...
        MavenUtils.removeDuplicate(dependencyList, this.comparator);
