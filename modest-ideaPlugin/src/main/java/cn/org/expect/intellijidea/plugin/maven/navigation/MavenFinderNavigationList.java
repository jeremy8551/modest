...
public class MavenFinderNavigationList implements NavigationItem, ItemPresentation, MavenFinderNavigation {
    ...
    public String getName() {
        return MavenFinderNavigationList.class.getSimpleName() + ":" + this.artifact.getGroupId() + ":" + this.artifact.getArtifactId() + ":" + this.artifact.getVersion();
    }
    ...
    public boolean equals(Object obj) {
        return obj != null && obj.getClass().equals(this.getClass()) && ((MavenFinderNavigationList) obj).id == this.id;
    }
