...
public class AbstractFqcnLogTest {
    ...
    public void test0() {
        ...
        try {
            new PatternLog(null, AbstractFqcnLogTest.class, LogLevel.OFF, fqcn, false);
            Assert.fail();
        } catch (Exception e) {
        ...
        try {
            new PatternLog(new LogContextImpl(), AbstractFqcnLogTest.class, null, fqcn, false);
            Assert.fail();
        } catch (Exception e) {
            Assert.assertTrue(true);
        }
    ...
    public void test1() {
        String fqcn = null;
        PatternLog log = new PatternLog(new LogContextImpl(), AbstractFqcnLogTest.class, LogLevel.OFF, fqcn, false);
